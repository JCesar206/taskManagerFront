...
<footer className="w-full px-4 py-6">
	  <div className="bottom-0 fixed w-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl shadow-md rounded-full">
    	<div className="max-w-6xl mx-auto px-6 py-6 flex flex-col items-center gap-6">
				...
				<a href="https://jcesar206.github.io/myPersonalBlog/" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-300 hover:text-black transition" title="My Personal Blog">
					<FaHome size={20}/>
				</a>
				<a href="https://github.com/JCesar206" target="_blank" rel="noreferrer"
					className="text-gray-600 dark:text-gray-300 hover:text-black transition" title="Github">
          <FaGithub size={20}/>
        </a>
				<a href="https://www.linkedin.com/in/jcesar206" target="_blank" rel="noreferrer"
					className="text-gray-600 dark:text-gray-300 hover:text-black transition" title="LinkedIn">
          <FaLinkedin size={20}/>
        </a>
        <a href="mailto:jcesar206@hotmail.com" className="text-gray-600 dark:text-gray-300 
				hover:text-black transition" title="Hotmail"><FaEnvelope size={20}/></a>
				<a href="mailto:jcesary06@gmail.com" className="text-gray-600 dark:text-gray-300 
				hover:text-black transition" title="Gmail"><SiGmail size={20}/></a>
			</div>
			{/*Copyright*/}
